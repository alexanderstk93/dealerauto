...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        contactBackground:
          "url('https://images.unsplash.com/photo-1637494873826-795116ba38cc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')",
      },
